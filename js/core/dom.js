...
/** Anhaengen, das null und false stillschweigend ueberspringt. Ohne diesen
 *  Helfer muss jede Ansicht jeden moeglicherweise leeren Abschnitt einzeln
 *  pruefen -- und genau das wurde beim ersten Lauf vergessen. */
export function anhaengen(eltern, ...teile) {
  for (const teil of teile.flat()) {
    if (teil === null || teil === undefined || teil === false) continue;
    eltern.appendChild(typeof teil === "string" ? document.createTextNode(teil) : teil);
  }
  return eltern;
}
...
const ICONS = {
  ...
  // --- eigene Zeichen der CoWork-App ---
  eingang: '<path d="M3.5 13h4l1.5 2.5h6L16.5 13h4M3.5 13 6 5.5h12L20.5 13v5a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 18z"/>',
  vorgaenge: '<path d="M6 3.5h8l4 4v13H6z"/><path d="M14 3.5v4h4M9 12h6M9 15.5h6"/>',
  aufgaben: '<path d="M4.5 7.5 6 9l2.5-3M4.5 15.5 6 17l2.5-3M11.5 8h8M11.5 16h8"/>',
  durchlauf: '<path d="M4.5 12h11M11.5 8l4 4-4 4"/><path d="M19.5 4.5v15"/>',
  warnung: '<path d="M12 4.5 21 19.5H3z"/><path d="M12 10v4M12 16.6v.4"/>',
  uhr: '<circle cx="12" cy="12" r="8.5"/><path d="M12 7.5V12l3 2"/>',
  person: '<circle cx="12" cy="8.5" r="3.5"/><path d="M5.5 19.5a6.5 6.5 0 0 1 13 0"/>',
  kreuz: '<path d="M6.5 6.5 17.5 17.5M17.5 6.5 6.5 17.5"/>',
};
